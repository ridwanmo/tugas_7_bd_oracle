              ...
              <form class="form-horizontal" action="add_transaksi.php" method="post">
               <div class="form-row">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control" name="total_beli" placeholder="TOTAL_BELI">
                </div>
                <div class="form-group col-md-6">
                  <label for="">TOTAL BAYAR</label>
                  <input type="text" class="form-control" name="total_bayar" placeholder="TOTAL_BAYAR">
                </div> 
