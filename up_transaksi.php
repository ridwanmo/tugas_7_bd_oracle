    ...
    <div class="main-panel">
      ...
      <?php
        ...
        if (isset($_GET['id'])) {
          ...
          $stid = oci_parse($con,"SELECT * FROM transaksi WHERE ID_TRANSAKSI = '$id'");
          oci_execute($stid);
      ...
      <form class="form-horizontal" action="proses_update_transaksi.php" method="post">
       <div class="form-row">
        ...
        <div class="form-group col-md-6">
          <label for="">TGL_TRANSAKSI</label>
          <input type="text" class="form-control" name="tgl_transaksi" value="<?= $d['TGL_TRANSAKSI'] ?>">
        </div>
        <div class="form-group col-md-6">
          <label for="">TOTAL_BELI</label>
          <input type="text" class="form-control" name="total_beli" value="<?= $d['TOTAL_BELI'] ?>">
        </div>
        <div class="form-group col-md-6">
          <label for="">TOTAL_BAYAR</label>
          <input type="text" class="form-control" name="total_bayar" value="<?= $d['TOTAL_BAYAR'] ?>">
        </div>
        </div>                                                  
