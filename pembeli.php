              ...
              <form class="form-horizontal" action="add.php" method="post">
               <div class="form-row">
                <div class="form-group col-md-6">
                  <label for="">ID BELI</label>
                  <input type="text" class="form-control" name="id_beli" placeholder="ID_BELI">
                </div>
                <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control" name="tgl_beli" placeholder="TGL_BELI">
                </div> 
                <div class="form-group col-md-6">
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        <?php 
    include 'koneksi.php';
    $stid = oci_parse($con, 'SELECT * from PEMBELI');
    ...
    while (($d = oci_fetch_array ($stid, OCI_BOTH)) != false) {
      ?>
                        <tr>                          
                          ...
                          <td class="td-actions">
              <a href="up_pembeli.php?id=<?= $d['ID_BELI'] ?>">
                            <button type="button" rel="tooltip" class="btn btn-success">
                              <i class="material-icons">edit</i>
                            </button></a>
              <a href="del_pembeli.php?id=<?= $d['ID_BELI'] ?>" 
